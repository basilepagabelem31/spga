...
<body>
    <div class="container">
        ...
        <p>Bonjour,</p>
        <p>Nous avons le plaisir de vous informer qu'une nouvelle commande incluant votre produit a été passée sur notre plateforme.</p>
        ...
        <div class="details">
            ...
            <ul>
                ...
                <li><strong>Produit Commandé :</strong> {{ $product->name }}</li>
                <li><strong>Quantité Commandée :</strong> {{ number_format($orderedQuantity, 2) }} {{ $product->sale_unit }}</li>
                <li><strong>Stock Restant :</strong> {{ number_format($product->current_stock_quantity, 2) }} {{ $product->sale_unit }}</li>
            </ul>
        </div>
