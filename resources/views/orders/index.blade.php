...
<style>
    ...
    .table thead th:nth-child(1), /* Code Commande */
    .table tbody td:nth-child(1) {
        min-width: 150px;
    }
    .table thead th:nth-child(2), /* Client */
    .table tbody td:nth-child(2) {
        min-width: 150px;
    }
    .table thead th:nth-child(3), /* Date Commande */
    .table tbody td:nth-child(3) {
        min-width: 150px;
    }
    .table thead th:nth-child(4), /* Montant Total */
    .table tbody td:nth-child(4) {
        min-width: 120px;
    }
    .table thead th:nth-child(5), /* Mode Livraison */
    .table tbody td:nth-child(5) {
        min-width: 150px;
    }
    .table thead th:nth-child(6), /* Mode Paiement */
    .table tbody td:nth-child(6) {
        min-width: 150px;
    }
    .table thead th:nth-child(7), /* Statut */
    .table tbody td:nth-child(7) {
        min-width: 120px;
    }
    .table thead th:nth-child(8), /* Validé par */
...
<div class="container py-4">
    ...
    <form action="{{ route('orders.index') }}" method="GET" class="mb-4 p-4 bg-white rounded-4 shadow-sm">
        <div class="row g-3 align-items-end">
            <div class="col-md-4">
                <label for="order_code_search" class="form-label">Recherche par code</label>
                <input type="text" class="form-control" id="order_code_search" name="order_code_search" placeholder="Code de commande..." value="{{ request('order_code_search') }}">
            </div>
            <div class="col-md-4">
                <label for="filter_client" class="form-label">Filtrer par client</label>
                    ...
                    <tbody>
                        @forelse ($orders as $order)
                            <tr>
                                ...
                                <td>{{ $order->validatedBy->full_name ?? $order->validatedBy->email ?? 'Non validé' }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center text-muted py-4">Aucune commande trouvée.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
